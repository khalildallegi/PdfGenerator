  ...
  Future<void> _generatePdf() async {
    ...
    String nombreEnLettresDouble(double nombre) {
      ...
      if (decimal == 0) {
        ...
        return '$entierEnLettres virgule $decimalEnLettres';
      }
    }

    String fullAmountInWords =
        nombreEnLettresDouble(totalAmount + (totalAmount / 100.00) + 1.00);
            ...
            children: [
              pw.Text(
                ...
                style: pw.TextStyle(
                  ...
                  color:
                      PdfColors.blue, // Set the color of the text itself here
                ),
              ),
              ...
              pw.Align(
                alignment: pw.Alignment.centerRight,
                child: pw.Text(
                    'Total TTC: \ ${(totalAmount + (totalAmount / 100) + 1.000).toStringAsFixed(2)}',
                    style: pw.TextStyle(
